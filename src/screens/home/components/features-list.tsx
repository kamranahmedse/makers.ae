  ...
  return (
    <SimpleGrid gridTemplateColumns={ ['1fr', '1fr', '1fr 400px', '1fr 400px'] }>
      ...
      <Stack marginLeft={ [0, 0, '40px', '40px'] }>
        <FeatureListItem>
          Join <ChakraLink color='yellow.300' _focus={ { outline: 'none', boxShadow: 'none', textDecoration: 'none' } } fontWeight={ 600 } href={ siteConfig.discord.joinUrl } target='_blank'>our discord</ChakraLink> to get connected with other makers in the region
        </FeatureListItem>
